...
export default function GlobalPlatformHub() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center text-zinc-200 relative selection:bg-indigo-500/30 overflow-hidden">
            ...
            <header className="w-full max-w-6xl flex items-center justify-between px-6 py-5 z-20">
                ...
                <div className="flex-1 max-w-md mx-6 relative group">
                    ...
                    <input 
                        ...
                        className="w-full bg-white/[0.02] border border-white/[0.05] hover:border-white/[0.1] focus:border-indigo-500/30 focus:bg-white/[0.04] text-zinc-200 placeholder-zinc-600 text-sm rounded-full py-2.5 pl-11 pr-4 outline-none transition-all duration-300 backdrop-blur-md"
                    />
                </div>
                        ...
                        {loading ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {filteredEvents.map((event) => (
                                    <div key={event.slug} className="bg-white/[0.01] hover:bg-white/[0.04] backdrop-blur-xl border border-white/[0.05] rounded-3xl p-6 flex flex-col transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] group">
